	...
	{	
		...
		**/
		public static function _after_added_wpam_transaction($data=array())
		{
			...
			$buyer_sms_notify = websmslk_get_option( 'wpam_order_status_'.$status, 'Websms_wpam_general', 'on' );
			$admin_sms_notify = websmslk_get_option( 'wpam_admin_notification_'.$status, 'Websms_wpam_general', 'on' );
			
			$buyer_sms_content = websmslk_get_option( 'wpam_sms_body_'.$status, 'Websms_wpam_message', WebsmsMessages::DEFAULT_WPAM_BUYER_SMS_TRANS_STATUS_CHANGED );
						
			$admin_sms_content = websmslk_get_option( 'wpam_admin_sms_body_'.$status, 'Websms_wpam_message', WebsmsMessages::DEFAULT_WPAM_ADMIN_SMS_TRANS_STATUS_CHANGED );
			if(sizeof($am_user)>0)
			{
		...
		public static function _after_changed_wpam_status($data=array())
		{
			...
			$buyer_sms_content = websmslk_get_option( 'wpam_sms_body_'.$status, 'Websms_wpam_message', WebsmsMessages::DEFAULT_WPAM_BUYER_SMS_STATUS_CHANGED );
			
			$admin_sms_content = websmslk_get_option( 'wpam_admin_sms_body_'.$status, 'Websms_wpam_message', WebsmsMessages::DEFAULT_WPAM_ADMIN_SMS_STATUS_CHANGED );
		...
		{
			return (websmslk_get_option('buyer_signup_otp', 'Websms_general')=="on") ? true : false;
		}
