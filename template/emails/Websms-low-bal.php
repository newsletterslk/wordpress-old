                ...
                <td align="center" style="padding-top:30px;padding-bottom:30px;">
                    <table align="center" style="max-width:475px;width:100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#fafafa" align="center" style="padding:25px 20px;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;font-size:12px;line-height:16px;color:#9fb1c1"><img alt="Websms.lk SMS" src="https://www.Websms.co.in/logo/www.Websms.co.in.png" style="padding-bottom:20px;" width="120">
