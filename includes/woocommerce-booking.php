...
class WebsmsWcBooking
{
	...
	public static function triggerSms( $booking_id ) 
	{
		if ( $booking_id ) {
			...
			$admin_message=websmslk_get_option( 'wcbk_admin_sms_body_'.$booking_status, 'Websms_wcbk_message', '');
			$is_enabled=websmslk_get_option( 'wcbk_order_status_'.$booking_status, 'Websms_wcbk_general');
			...
			{
				$buyer_message=websmslk_get_option( 'wcbk_sms_body_'.$booking_status, 'Websms_wcbk_message', '');
			...
			if(websmslk_get_option( 'wcbk_admin_notification_'.$booking_status, 'Websms_general') == 'on' && $admin_phone_number!='')
			{
				$admin_message = websmslk_get_option( 'wcbk_admin_sms_body_'.$booking_status, 'Websms_wcbk_message', '');
