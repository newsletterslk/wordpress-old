 ...
 *
 * @author Websms\Cozyvision Technologies pvt. ltd. 
 */
...
/**
	...
	public static function websms_lk_wc_submenu() {
		add_submenu_page( 'woocommerce', 					'Websms.lk SMS', 						'Websms.lk SMS', 'manage_options', 'websms.lk', __CLASS__ . '::settings_tab');
	
		add_submenu_page( 'edit.php?post_type=download', 	'Websms.lk SMS', 						'Websms.lk SMS', 'manage_options', 'websms.lk', __CLASS__ . '::settings_tab');
		
		add_submenu_page( 'gf_edit_forms', 					__( 'Websms.lk SMS', 'gravityforms' ),	__( 'Websms.lk SMS', 'gravityforms' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');
		
		add_submenu_page( 'ultimatemember', 				__( 'Websms.lk SMS', 'ultimatemember' ), __( 'Websms.lk SMS', 'ultimatemember' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');
		
		add_submenu_page( 'wpcf7', 							__( 'Websms.lk SMS', 'wpcf7' ), 		__( 'Websms.lk SMS', 'wpcf7' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');
		
		add_submenu_page( 'pie-register', 					__( 'Websms.lk SMS', 'pie-register' ), 	__( 'Websms.lk SMS', 'pie-register' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');
		
		add_submenu_page( 'wpam-affiliates', 				__( 'Websms.lk SMS', 'affiliates-manager' ), __( 'Websms.lk SMS', 'affiliates-manager' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');		
		
		add_submenu_page( 'learn_press', 					__( 'Websms.lk SMS', 'learnpress' ), 	__( 'Websms.lk SMS', 'learnpress' ), 'manage_options', 'websms.lk' , __CLASS__ . '::settings_tab');
	} 
	...
	public static function Websms_warranty_tab()
	{
			...
			?>
			<a href="admin.php?page=warranties-settings&tab=Websms_warranty" class="nav-tab <?php echo ($active_tab == 'Websms_warranty') ? 'nav-tab-active' : ''; ?>"><?php _e('Websms.lk SMS', 'wc_warranty'); ?></a>
			<?php
	}
    ...
    ?>
		<div class="notice notice-warning is-dismissible">
			<p><a href="admin.php?page=websms.lk"><?php _e( 'Login to Websms.lk SMS', 'Websms' ); ?></a> <?php _e( 'to configure SMS Notifications', 'Websms'); ?></p>
		</div>
		<?php
	}	
		...
		if(self::isUserAuthorised())
		{
			...
			if(is_array($credits['description']) && array_key_exists('routes', $credits['description']))
			{
				foreach($credits['description']['routes'] as $credit){
					$items[] = sprintf('<a href="%1$s" class="Websms-credit"><strong>%2$s SMS</strong> : %3$s</a>', admin_url( 'admin.php?page=websms.lk' ), ucwords($credit['route']), $credit['credits']).'<br />';
				}
			}
		}
		return $items;
   ...
   {	
	   ...
	   //return true;
	   wp_redirect(  admin_url( 'admin.php?page=websms.lk&m=1' ) );
	   exit;
   }
   ...
   public static function getvariables()
   {
	...
	public static function get_settings() {
		...
		$Websms_helper = ""
		?>
		<a href="#">Welcome to Websms.lk WordPress Plugin</a>
		...
		<div class="Websms_box Websms_settings_box" style="margin-top:30px;">
           <div class="Websms_nav_tabs">
            <?php 
				...
				echo get_websmslk_template('views/websms_nav_tabs.php',$params);
			?>
			</div>
		 <div>
			<div class="Websms_nav_box Websms_nav_global_box Websms_active general"><!--general tab-->
				<?php 
					$params=array
					(
            ...
            <div class="Websms_nav_box Websms_nav_css_box customertemplates"><!--customertemplates tab-->
			...
			<div class="Websms_nav_box Websms_nav_admintemplates_box admintemplates"><!--admintemplates tab-->
			<?php 
					$params=array(
						'order_statuses'=>$order_statuses,
						'hasWoocommerce'=>$hasWoocommerce,
			...
			<!--Edd download customer templates-->
					<div class="Websms_nav_box Websms_nav_eddcsttemplates_box eddcsttemplates">
						...
						<?php 
							...
							echo get_websmslk_template('views/edd_customer_template.php',$params);
						?>
					</div>
			<!--/--Edd download customer templates-->
			...
			<?php 
				$params=array('edd_order_statuses'=>$edd_order_statuses);
				echo get_websmslk_template('views/edd_admin_template.php',$params);
			?>			
		  </div>
			<!--/-EDD admintemplates tab-->
			...
			<!--Wp Affiliate Manager Customer templates-->
					...
					<div class="Websms_nav_box Websms_nav_wpamcsttemplates_box wpamcsttemplates">
						...
						<?php 
							echo get_websmslk_template('views/affiliate_customer_template.php',$params);
						?>
					</div>
			<!--/--Wp Affiliate Manager Customer templates-->
			<!--Wp Affiliate Manager Admin templates-->
					...
					<div class="Websms_nav_box Websms_nav_wpamadmintemplates_box wpamadmintemplates">
						<?php 
							echo get_websmslk_template('views/affiliate_admin_template.php',$params);
						?>
					</div>
			<!--/--Wp Affiliate Manager Admin templates-->
			<?php }?>	
			...
			<?php
			echo get_websmslk_template('views/lpress_customer_template.php',$params);
			?>
			</div>
			<!--/--Learnpress Customer templates-->
			...
			<?php
			echo get_websmslk_template('views/lpress_admin_template.php',$params);
			?>
			</div>
			<!--/--Learnpress Admin templates-->
			<?php }?>
			<!--/-Learnpress tabs-->
			<div class="Websms_nav_box Websms_nav_callbacks_box otp"><!--otp tab-->
				...
				*/
				...
				<tr valign="top" class="top-border">
					...
					<tr valign="top">
						...
						<td>
						<input type="checkbox" name="Websms_general[low_bal_alert]" id="Websms_general[low_bal_alert]" class="Websms_box notify_box" <?php echo (($low_bal_alert=='on')?"checked='checked'":'');?> onchange="toggleReadonly(this, 'input[type=number]')" 
						/> <?php _e( 'Low Balance Alert', WebsmsConstants::TEXT_DOMAIN ) ?> <input type="number" min="500" name="Websms_general[low_bal_val]" id="Websms_general[low_bal_val]" value="<?php echo $low_bal_val; ?>" >
					...
					<tr valign="top">
						...
						<td>
						<input type="checkbox" name="Websms_general[enable_short_url]" id="Websms_general[enable_short_url]" class="notify_box" <?php echo (($enable_short_url=='on')?"checked='checked'":''); ?>
					/><?php _e( 'Enable Short Url', WebsmsConstants::TEXT_DOMAIN ) ?>
			...
			<div class="Websms_nav_box Websms_nav_credits_box credits <?php echo $credit_show?>"><!--credit tab-->
			   <table class="form-table">
				<tr valign="top">
						<td>
						<?php 		
			...
			<div class="Websms_nav_box Websms_nav_support_box support"><!--support tab-->
			   <table class="form-table">
				<tr valign="top">
					<td>
				...
				<tr valign="top">
					<td>
						<div class="col-lg-12 creditlist" >
						  <div class="col-lg-8 route">
							<h3><a href="https://www.websms.lk/contact.html" target="_blank" >Our Support Center</a>
							</h3>
						  </div>
						</div>
					</td>
				...
				<tr valign="top">
					<td>
						<div class="col-lg-12 creditlist" >
						  <div class="col-lg-8 route">
							<h3><?php _e('Email Support',WebsmsConstants::TEXT_DOMAIN)?>: <a href="mailto:support@websms.lk" target="_blank">support@websms.lk</a></h3>
						  </div>
						</div>
					</td>
				</tr>
				<tr valign="top">
					<td>
						<div class="col-lg-12 creditlist" >
						  <div class="col-lg-8 route">
							<h3><?php _e('Phone Support',WebsmsConstants::TEXT_DOMAIN)?>: +94-759 002 002</h3>
						  </div>
						</div>
					</td>
				</tr>
